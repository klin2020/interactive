document.addEventListener("DOMContentLoaded", function(){
    ...
    for (let i = 0; i < num_flower; i++)
    {
        ...
        if(type_flower == 1){
            flower = '../../toolforone/images/home_flower.png'
        }
        else if(type_flower == 2){
            flower = '../../toolforone/images/home_flower2.png'
        }
        else if(type_flower == 3){
            flower = '../../toolforone/images/home_flower3.png'
        }
        else if(type_flower == 4){
            flower = '../../toolforone/images/home_flower4.png'
        }
        else{
            flower = '../../toolforone/images/home_flower5.png'
        }
